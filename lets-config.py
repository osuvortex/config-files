...
class Config:
	def __init__(self):
		self._config = {
			...
			"DB_USERNAME": config("DB_USERNAME", default="db-username"),
			"DB_PASSWORD": config("DB_PASSWORD", default="db-pass"),
			"DB_NAME": config("DB_NAME", default="db-name"),
			...
			"SERVER_URL": config("SERVER_URL", default="https://osu.vortex-tds.studio"),
			"BANCHO_URL": config("BANCHO_URL", default="http://127.0.0.1:5001"),
			"BANCHO_API_KEY": config("BANCHO_API_KEY", default="ci-key"),
			...
			"OSU_API_KEY": config("OSU_API_KEY", default="osu-api-key"),

			"CHEESEGULL_API_URL": config("CHEESEGULL_API_URL", default="http://storage.ripple.moe/api"),
